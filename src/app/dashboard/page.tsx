...
import { Plus, HardDrive, FileText, Clock, AlertCircle, AlertTriangle, ShieldAlert, Trash2, Search, Download } from 'lucide-react';
    ...
    <div className="space-y-8 pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-900/50 backdrop-blur-xl border border-white/5 rounded-2xl p-6">
          ...
          <p className="text-3xl font-bold text-white mb-2">{documents.length}</p>
        </div>
