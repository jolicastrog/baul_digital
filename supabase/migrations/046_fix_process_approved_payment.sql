-- ============================================================================
-- 046: Re-aplicar process_approved_payment versión correcta (migración 024)
--
-- La función en producción era la versión de migración 021 (sin plan_id),
-- pero la tabla subscriptions ya tiene plan_id NOT NULL desde migración 022.
-- Esto causaba error 23502 al procesar pagos Bold.
-- ============================================================================
...
SELECT 'Migración 046 aplicada correctamente' AS resultado;
