-- ============================================================================
-- MIGRACIÓN 023: Corregir columna plan_type en subscriptions
--
-- La migración 022 agregó plan_id FK → plans pero no eliminó plan_type,
-- que sigue siendo NOT NULL. process_approved_payment no la incluía en el
-- INSERT causando falla silenciosa.
-- Solución: sincronizar plan_type desde plan_id y actualizar la función.
-- ============================================================================

-- 1. Asegurar que plan_type esté sincronizado con plan_id actual
UPDATE public.subscriptions s
SET plan_type = p.code
FROM public.plans p
WHERE p.id = s.plan_id
  AND s.plan_type IS DISTINCT FROM p.code;

-- 2. Actualizar process_approved_payment para incluir plan_type en el INSERT
...
BEGIN
  ...
  -- Crear o actualizar suscripción (incluye plan_type para compatibilidad)
  ...
  -- Registrar pago en payment_orders
